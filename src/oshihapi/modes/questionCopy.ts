...
export const QUESTION_COPY: Record<ModeId, Record<string, QuestionCopy>> = {
  ...
  kawaii: {
    ...
    q_addon_voice_audio_bonus_value: { title: "音声特典や店舗特典ドラマ、どれくらい大事？" },
    q_addon_voice_listen_intent: { title: "このドラマCD、実際に聴く予定は？" },
  ...
  oshi: {
    ...
    q_addon_voice_audio_bonus_value: { title: "音声 bonus / 店舗特典ドラマの重要度は？" },
    q_addon_voice_listen_intent: { title: "実際の listen intent は？" },
