      ...
      <Card className="space-y-4">
        <div className="rounded-2xl border border-accent/20 bg-accent/5 px-4 py-3 dark:border-accent/25 dark:bg-accent/10">
          <div className="flex flex-wrap items-center gap-2">
            <p className="text-sm font-semibold text-slate-900 dark:text-zinc-50">このフローの判断シナリオ</p>
          ...
          <p className="mt-1 text-xs text-slate-500 dark:text-zinc-400">
            最適化: {scenarioCoverage.optimizationSummary} / {scenarioCoverage.flowHelperHint}
          </p>
        </div>
        <div className="space-y-2">
